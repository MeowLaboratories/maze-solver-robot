void main_run_L()
{
  ...
  while(1)
  {
   robot_stop();
    ...
    if(digitalRead(switch_1) == LOW && digitalRead(switch_2) == HIGH && digitalRead(switch_3) == LOW) return_to_start();
  }
  ...
  while(1)
    {
        ...
        for( i = 0 ; maze[i] != 0 ; i++)
        {
            if(maze[i] == 4 && i != 0) //B
            {
                ...
                if(maze[i-1] == 1 && maze[i+1] == 2) // LBS = R
                {
                    maze[i-1] = 5;
                    maze[i] = 3;//R
                    maze[i+1] = 5;
                ...
                if(maze[i-1] == 2 && maze[i+1] == 1)//SBL = R
                {
                    maze[i-1] = 5;
                    maze[i] = 3; //R
                    maze[i+1] = 5;
                ...
                if(maze[i-1] == 1 && maze[i+1] == 1)//LBL = S
                {
                    maze[i-1] = 5;
                    maze[i] = 2; //S
                    maze[i+1] = 5;
